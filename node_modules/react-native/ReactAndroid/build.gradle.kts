...
// 获取项目根目录路径
var projectRootDir = rootDir.parent
//println("codegenDir directory: $projectRootDir/node_modules/@react-native/codegen")
...
android {
  ...
  defaultConfig {
    ...
    externalNativeBuild {
      cmake {
        arguments(
            "-DCMAKE_TOOLCHAIN_FILE=D:/DevTool/mingw-w64/mingw_toolchain.cmake", // 指定自定义工具链文件的路径
